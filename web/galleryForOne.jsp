...
<div id="galleryContainer">
    ...
    <% Set<String> names =(Set<String>) request.getAttribute("thumbNames");
        Set<String> multimediaNames = (Set<String>) request.getAttribute("mediaNames");%>
    ...
    <c:forEach var="thing" items="<%=names%>">
        ...
        --%>
        <a href = "${thing}" ><img src="/Thumbnails/thumb${fn:substring(thing,17,-1)}"></a>
    </c:forEach>

    <h2>Multimedia</h2>
    <c:forEach var="mm" items="<%= multimediaNames%>">
        <a href ="${mm}"><img src="images/headphones.jpg" width="200"></a>
        <p>${mm}</p>
