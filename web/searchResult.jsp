...
<div>
    <h4>Sort by:</h4>
    <a href="SearchArticlesByArticleNameServlet?info=<%=result%>">Article Name</a>
    <a href="SearchArticlesByUsernameServlet?info=<%=result%>">Username</a>
    <a href="SearchArticlesByDateServlet?info=<%=result%>">Date</a>
</div>
<br>
<br>
<%
