    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <% if(author==null){%>
                <li><a href = "RegistrationForm.jsp" class= pointer><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>
                ...
                <% if(author.getId()== 62){%>
                <li><a href = "adminPage.jsp" class= pointer><span class="glyphicon glyphicon-user"></span> Admin Page</a></li>
                <%}%>
